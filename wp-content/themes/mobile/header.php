          ...
          <div class="header master_header row align-items-center">
            <div class="col-4" style="padding: 0;">
              <?php if(is_user_logged_in()) { ?>
                ...
                <button type="button" class="btn btn-lg btn-link btn-back btn-to_endNow hidden" data-toggle="popover" data-placement="bottom" title="Протокол остановлен!" data-content="Выполнение протокола будет прервано по окончании текущей фазы."><i class="far fa-stop-circle"></i></button>
              <?php } ?>
            </div>
