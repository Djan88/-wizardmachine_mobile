          ...
          <div class="modal-body mode_content">
            <div class="container">
              <div id="accordion" class="manual_wrap">
                ...
                <h3>Карта Маг (I)</h3>
                <div class="manual_content">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/cards/magician_1.png" alt="zones" alt="magician">
                ...
                <div class="manual_content">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/cards/lovers_1.png" alt="zones" alt="lovers">
                ...
                <div class="manual_content">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/cards/hanged_man_1.png" alt="zones" alt="hanged_man">
