        ...
        <div class="modal-content">
          ...
          <div class="modal-body mode_content">
            ...
            <div class="how_to_elem">
              <p>Переместите зону <span class="zone_test"></span> на область руки, как продемострировано ниже. <br>За тем запустите выполнение программы. <i class="far fa-flag"></i></p>
