        ...
        <div class="modal-content">
          ...
          <div class="modal-body mode_content">
            ...
            <div class="how_to_elem">
              <p>Переместите зону <span class="zone_test"></span> на область руки, как продемострировано ниже. <br>За тем запустите выполнение программы. <span class="acent_text"><i class="far fa-flag"></i></span></p>
              <p>После того как все карты будут выложены появится возможность завершить работу протокола по усмотрению оператора кликнув по кнопке <span class="acent_text"><i class="fas fa-hourglass-start"></i></span> в правом верхнем углу.</p>
