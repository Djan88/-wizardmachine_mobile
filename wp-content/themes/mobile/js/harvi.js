jQuery(document).ready(function () {
    ...
    //     moon_day = moon_day-1;
    // }
    moon_day = parseInt(localStorage.getItem('moon_day_ls'));
    // moon_day = 10;
        ...
        if(pointsStatus == false){
          ...
          pointsStatus = true;
            ...
            if (moon_day == 13 || moon_day == 17) {
                zone_top = parseInt(jQuery('.draggable_v-').css('top')) + 70;
                jQuery('.card_devil, .card_ghost_devil').addClass('rotated_').css('transform', 'rotate(45deg)');
                zone_top_alt = parseInt(jQuery('.draggable_v1').css('top')) - 70;
                ...
                zone_top = parseInt(jQuery('.draggable_s5').css('top')) + 70;
                zone_top_alt = parseInt(jQuery('.draggable_v1').css('top')) + 20;
            } else if (moon_day == 10 || moon_day == 20) {
                zone_top = parseInt(jQuery('.draggable_s5').css('top')) + 60;
                zone_top_alt = parseInt(jQuery('.draggable_d2').css('top')) - 20;
            } else if (moon_day == 9 || moon_day == 21) {
                zone_top = parseInt(jQuery('.draggable_s5').css('top')) + 20;
                zone_top_alt = parseInt(jQuery('.draggable_d2').css('top')) + 20;
            } else if (moon_day == 8 || moon_day == 22) {
                zone_top = parseInt(jQuery('.draggable_s5').css('top')) - 50;
                zone_top_alt = parseInt(jQuery('.draggable_d2_1').css('top')) + 20;
            } else if (moon_day == 7 || moon_day == 23) {
                zone_top_alt = parseInt(jQuery('.draggable_d3').css('top')) + 20;
                zone_top = parseInt(jQuery('.draggable_s4').css('top')) + 30;
            } else if (moon_day == 6 || moon_day == 24) {
                zone_top_alt = parseInt(jQuery('.draggable_v4').css('top')) + 20;
                zone_top = parseInt(jQuery('.draggable_v4').css('top')) + 20;
                ...
                zone_top_alt = parseInt(jQuery('.draggable_d5').css('top')) + 20;
                zone_top = parseInt(jQuery('.draggable_v2').css('top')) + 20;
                ...
                zone_top = parseInt(jQuery('.draggable_v0').css('top')) + 20;
