			...
			<div class="mobile_screen mobile_screen_what_way">
				<div class="col-md-6 col-sm-8 offset-md-3 offset-sm-2">
						...
						<div class="row">
					      ...
					      <div class="protocols_item_img" style="margin-top: 20px;">
					      	<img src="<?php echo get_template_directory_uri(); ?>/img/icon_master_h_l.png" alt="" class="main_menu_icon">
					      </div>
					    </div>
					  </div>
						<div class="row">
					      ...
					      <div class="protocols_item_img" style="margin-top: 20px;">
					      	<!-- <i class="far fa-moon"></i> -->
					      	<img src="<?php echo get_template_directory_uri(); ?>/img/icon_elems.png" alt="" class="main_menu_icon">
					      </div>
					    </div>
