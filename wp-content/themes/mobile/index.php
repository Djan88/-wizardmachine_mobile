...
<?php } else { ?>
	<div class="col col-12 protocols">
		<?php if(is_user_logged_in()){ ?>
			...
			<?php } else { ?>
				<div class="subscriber_info">Вы видите это сообщение, потому, что зарегистрированы в <a href="http://tarotmachine.ru/">"Tarot Machine"</a> но на данный момент не имеете действующего доступа к программе.
	        <p>
		...
		<?php } else { ?>
			<div class="row">
				...
				<div class="col-md-9 col-xs-12 start_info">
					...
					<p>Стоимость курса <b>«TarotMachine — Мастер Реальности»</b> — <b>35 000 руб.</b><br>В эту стоимость входит месячный обучающий курс по работе с программой «TarotMachine» и годовой доступ к самой программе. В дальнейшем, продление доступа на 2-й год и последующие будет стоить <b>25 000 руб.</b> Оплату можно будет производить из личного кабинета пользователя. Достпно несколько способов оплаты, включая оплату Банковской Картой.</b></p>
